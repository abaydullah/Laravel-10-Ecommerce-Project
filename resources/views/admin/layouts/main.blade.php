...
{{--                                <span class="badge badge-info right">6</span>--}}
                        ...
                        <ul class="nav nav-treeview bg-gray">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.products.create')}}" class="nav-link {{request()->segment(2) === 'products' && request()->segment(3) === 'create' ? 'active' : ''}}">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.products.index')}}" class="nav-link {{request()->segment(2) === 'products' && request()->segment(3) === null ? 'active' : ''}}">
