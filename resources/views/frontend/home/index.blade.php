...
@section('content')
    ...
    <section class="p-0 layout-7">
        <div class="slide-1 home-slider">
            <div>
                <div class="home">
                    <img src="../assets/images/marketplace/home-slider/7.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>for men</h4>
                                        <h1 class="font-fraunces">spring collection</h1><a href="#"
            ...
            <div>
                <div class="home">
                    <img src="../assets/images/marketplace/home-slider/5.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div>
                <div class="home">
                    <img src="../assets/images/marketplace/home-slider/6.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ti-bolt"></i> deals of the day</h2>
                        <div class="timer">
                            <p id="demo"></p>
                        </div>
                    </div>
                    ...
                    <div class="slide-6-product product-m no-arrow">
                        <div class="product-box product-wrap">
                            ...
                            <div class="product-detail">
                                ...
                                <ul class="color-variant quantity-variant box-l">
                                    <li class="bg-light">2kg</li>
                                    <li class="bg-light">5kg</li>
                                </ul>
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/21.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap bg-color-cls sm-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/27.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                            ...
                            <div class="product-detail">
                                ...
                                <h4>$500.00</h4>
                                <ul class="image-swatch mb-0">
                                    <li><a href="#"><img src="../assets/images/fashion/pro/m-001.jpg" alt=""
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/29.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
    ...
    <section class="pt-0 ratio_square section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="h-100">
                        <img src="../assets/images/marketplace/banner/vertical2.jpg" class="img-fluid bg-img bg-top"
                             alt="">
                    </div>
                </div>
                <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                    <div class="marketplace-5 product-m no-arrow">
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                ...
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/40.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap bg-color-cls sm-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/31.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/36.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap bg-color-cls sm-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/33.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/39.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap bg-color-cls sm-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                            ...
                            <div class="product-detail">
                                ...
                                <h4>$500.00</h4>
                                <ul class="color-variant quantity-variant box-l">
                                    <li class="bg-light">1L</li>
                                    <li class="bg-light">2L</li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/13.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap bg-color-cls sm-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            ...
                            <div class="product-detail">
                                ...
                                <h4>$500.00</h4>
                                <ul class="color-variant quantity-variant box-l">
                                    <li class="bg-light">5</li>
                                    <li class="bg-light">6</li>
                                    <li class="bg-light">7</li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-box product-wrap">
    ...
    <section class="section-b-space">
        <img src="../assets/images/marketplace/product-banner.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="ratio_square">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="theme-card card-border bg-light border-0">
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img alt=""
                                                                                     ...
                                                                                     src="../assets/images/marketplace/pro/5.jpg"></a>
                                    ...
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img alt=""
                                                                                     class="img-fluid blur-up lazyload"
                                                                                     src="../assets/images/marketplace/pro/35.jpg"></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div>
                                ...
                                <div>
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img alt=""
                                                                                     class="img-fluid blur-up lazyload"
                                                                                     src="../assets/images/marketplace/pro-sm/3.jpg"></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div>
                                    ...
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img alt=""
                                                                                     class="img-fluid blur-up lazyload"
                                                                                     src="../assets/images/marketplace/pro-sm/4.jpg"></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div>
    ...
    <section class="section-b-space">
        <div class="container">
            <div class="row partition3 partition_3">
                <div class="col-lg-4 ratio_square">
                    <div class="theme-card card-border bg-light border-0">
                        <h5 class="title-border">new product</h5>
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/1.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/2.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/3.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/4.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/6.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                ...
                <div class="col-lg-4 center-slider border-0 ratio2_3">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="collection-banner mb-4 p-right text-end">
                                    <div class="img-part">
                                        <img src="../assets/images/marketplace/banner/21.jpg" alt=""
                                             class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <div class="contain-banner banner-3">
                                        <div>
                                            <h4 class="text-theme">save 30%</h4>
                                            <h2 class="font-cormorant text-dark">toy</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="collection-banner p-right text-end">
                                    <div class="img-part">
                                        <img src="../assets/images/marketplace/banner/22.jpg" alt=""
                                             class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <div class="contain-banner banner-3">
                                        <div>
                                            <h4 class="text-theme">save 60%</h4>
                                            <h2 class="font-cormorant text-dark">dumble</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/7.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/8.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/9.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/10.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/11.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 src="../assets/images/marketplace/pro/12.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
    ...
    <!-- product section start-->
    <section class="pt-0 ratio_square">
        <div class="container">
            <div class="row section-b-space">
                <div class="col-lg-3 col-md-4 col-sm-5 col-6">
                    <div class="h-100">
                        <img src="../assets/images/marketplace/banner/vertical3.jpg" class="img-fluid bg-img bg-top"
                             alt="">
                    </div>
                </div>
                    ...
                    <div class="marketplace-5 product-m no-arrow">
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/marketplace/pro/35.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                            ...
                            <div class="product-detail">
                                ...
                                <h4>$500.00</h4>
                                <ul class="image-swatch mb-0">
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-001.jpg"
                                                                      alt="" class="img-fluid"></a></li>
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-002.jpg"
                                                                      alt="" class="img-fluid"></a></li>
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-003.jpg"
                                                                      alt="" class="img-fluid"></a></li>
                                </ul>
                            </div>
                        </div>
